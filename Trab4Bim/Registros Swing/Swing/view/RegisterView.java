...
public class RegisterView extends JFrame implements IRegisterView{
	...
	public RegisterView() {
		...
		panel.add(cancel);
		addUser = createButton("Registrar", 300, 240, 100, 25);
		panel.add(addUser);
	...
	public void sendErrorNotification() {
		JOptionPane.showMessageDialog(panel, "Verifique seu registro, algo está errado.", "AVISO", JOptionPane.WARNING_MESSAGE);
	}
	...
	public void cleanPasswordFields() {
		...
		JOptionPane.showMessageDialog(panel, "Insira senhas iguais para prosseguir.",
